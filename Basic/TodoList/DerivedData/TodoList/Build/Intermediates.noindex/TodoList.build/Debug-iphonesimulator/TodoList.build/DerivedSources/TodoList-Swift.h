...
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tablewView;
@property (nonatomic, strong) IBOutlet UIBarButtonItem * _Null_unspecified editButton;
- (void)viewDidLoad;
- (void)doneButtonTap;
- (IBAction)tapEditButton:(UIBarButtonItem * _Nonnull)sender;
- (IBAction)tapAddButton:(UIBarButtonItem * _Nonnull)sender;
...
@interface ViewController (SWIFT_EXTENSION(TodoList)) <UITableViewDelegate>
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end

@class UITableViewCell;

@interface ViewController (SWIFT_EXTENSION(TodoList)) <UITableViewDataSource>

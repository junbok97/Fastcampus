...
SWIFT_CLASS("_TtC7Weather13SceneDelegate")
...
SWIFT_CLASS("_TtC7Weather14ViewController")
...
@property (nonatomic, weak) IBOutlet UIStackView * _Null_unspecified weatherStackView;
- (void)viewDidLoad;
- (IBAction)tapFetchWeatherButton:(UIButton * _Nonnull)sender;
